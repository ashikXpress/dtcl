    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="{{ route('update.our.activity',$activity->id) }}">
                    @csrf
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group {{ $errors->has('description') ? 'has-error' :'' }}">
                            ...
                            <div class="col-sm-10">
                                <textarea id="editor1" name="description" rows="10" cols="80">{{ $activity->description }}</textarea>
