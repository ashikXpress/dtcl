...
{{--                --}}
                ...
                <li class="treeview {{ in_array(Route::currentRouteName(), $subMenu) ? 'active' : '' }}">
                    ...
                    <ul class="treeview-menu {{ in_array(Route::currentRouteName(), $subMenu) ? 'active menu-open' : '' }}">
                        <li class="{{ Route::currentRouteName() == 'add.our.activity.form' ? 'active' : '' }}">
                            <a href="{{ route('add.our.activity.form') }}"><i class="fa fa-circle-o"></i> Add Our Activity</a>
                        </li>
                        <li class="{{ Route::currentRouteName() == 'all.activity' ? 'active' : '' }}">
                            <a href="{{ route('all.activity') }}"><i class="fa fa-circle-o"></i> All Activity</a>
                        </li>
