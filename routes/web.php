...
//    Route::post('/say/delete', 'SayController@delete')->name('delete_say');
    ...
    //our activity
    Route::get('add/activity','ActivityController@addOurActivityForm')->name('add.our.activity.form');
    Route::post('add/activity','ActivityController@addOurActivity')->name('add.our.activity');
    Route::get('edit/activity/{activity}','ActivityController@editOurActivity')->name('edit.our.activity');
    Route::post('update/activity/{activity}','ActivityController@updateOurActivity')->name('update.our.activity');
    Route::post('activity/delete','ActivityController@deleteOurActivity')->name('delete.our.activity');
    Route::get('all/activity','ActivityController@allActivity')->name('all.activity');
